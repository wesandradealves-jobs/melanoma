...
<html lang="en">
  <head>
    ...
    <title>CSS Transitions - Materialize</title>
    <!-- Favicons-->
  ...
  <body>
    <header>
      <nav class="top-nav">
        <div class="container">
          <div class="nav-wrapper"><a class="page-title">CSS Transitions</a></div>
        </div>
      </nav>
            ...
            <li class="bold"><a class="collapsible-header active waves-effect waves-teal">CSS</a>
              <div class="collapsible-body">
                <ul>
                  ...
                  <li class="active"><a href="css-transitions.html">Transitions</a></li>
