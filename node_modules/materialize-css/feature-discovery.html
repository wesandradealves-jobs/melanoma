...
<html lang="en">
  <head>
    ...
    <title>FeatureDiscovery - Materialize</title>
    <!-- Favicons-->
  ...
  <body>
    <header>
      <nav class="top-nav">
        <div class="container">
          <div class="nav-wrapper"><a class="page-title">FeatureDiscovery</a></div>
        </div>
      </nav>
            ...
            <li class="bold"><a class="collapsible-header active waves-effect waves-teal">JavaScript</a>
              <div class="collapsible-body">
                <ul>
                  ...
                  <li class="active"><a href="feature-discovery.html">FeatureDiscovery</a></li>
