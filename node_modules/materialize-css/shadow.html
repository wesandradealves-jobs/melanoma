...
<html lang="en">
  <head>
    ...
    <title>Shadow - Materialize</title>
    <!-- Favicons-->
            ...
            <li class="bold"><a class="collapsible-header active waves-effect waves-teal">CSS</a>
              <div class="collapsible-body">
                <ul>
                  ...
                  <li class="active"><a href="shadow.html">Shadow</a></li>
  ...
  <div class="row">
    ...
    <div class="col s12 m9 l10">
      ...
      <div id="shadow" class="section scrollspy">
        ...
        <p>You can easily apply this shadow effect by adding a <code class="language-markup">class="z-depth-2"</code> to an HTML tag. Alternatively you can extend any of these shadows with Sass using <code class="language-scss">@extend .z-depth-2</code>. A <code class="language-scss">z-depth-0</code> can be used to remove shadows from elements that have z-depths by default. </p>
        <div class="row">
