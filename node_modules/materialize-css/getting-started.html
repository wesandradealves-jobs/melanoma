    ...
    <div class="section col s12 m9 l10">
      <div id="download" class="row scrollspy">
        ...
        <div class="col s12 m6">
          ...
          <a id="download-source" class="btn waves-effect waves-light" href="http://materializecss.com/bin/materialize-v0.98.1.zip">Materialize<i class="material-icons right">file_download</i></a>
        </div>
        <div class="col s12 m6">
          ...
          <a id="download-sass" class="btn waves-effect waves-light" href="http://materializecss.com/bin/materialize-src-v0.98.1.zip">Source<i class="material-icons right">file_download</i></a>
        </div>
        <div class="col s12">
          <br>
