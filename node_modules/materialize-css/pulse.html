...
<html lang="en">
  ...
  <body>
    <header>
      <nav class="top-nav">
        <div class="container">
          <div class="nav-wrapper"><a class="page-title">Pulse</a></div>
        </div>
      </nav>
  ...
  <div class="row">
    <div class="col s12 m9 l10">
      ...
      <div id="pulse" class="section scrollspy">
        <p class="caption">Draw attention to your buttons with this subtle but captivating effect. Just add the class <code class="language-markup">pulse</code> to your button.</p>
